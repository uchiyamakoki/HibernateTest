 ...
 * 
 * @see com.akaxia.po.Sjzdxx
 * @author MyEclipse Persistence Tools
 */

public class SjzdxxDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(SjzdxxDAO.class);
	// property constants
	...
	public Sjzdxx findById(java.lang.Integer id) {
		...
		try {
			Sjzdxx instance = (Sjzdxx) getSession().get("com.akaxia.po.Sjzdxx",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Sjzdxx instance) {
		...
		try {
			List results = getSession().createCriteria("com.akaxia.po.Sjzdxx")
